...
\Large
  ...
  finish. The main required functions are listed below: 
  \begin{itemize}[noitemsep]
    \item \textbf{Milling:} For production to be successfull, the ability to 
      precisely mill each part down to the exact dimentions required.
    \item \textbf{Drilling:} For the mentions standardized part interfaces using
      attachments the ability to drill a hole with precise dimentions is required for part mounting. 
    \item \textbf{Tapping:} Tapping drill bits will be required along with the drilling capabilities 
      to allow for creation of skrewing threads inside of the pricecely dimensioned holes.
    \item \textbf{Nylon Sewing:} For the attached carry bag aswell as the sitting cusion the ability 
      to sew different sheets of nylon together.
    \item \textbf{Spray Painting:} For both the professional look and to make a air-dense sitting cusion
      the ability to apply spray paint and silicone coatings. For this a spray gun and compressor will
      need to be purchased.
    \item \textbf{Material Conformance Testing:} Standardized method to test each part for strict
      conformance. Material conformance will require standardized machinery to test each part rigirously
      for force resistance, corrosion resistance and paint adhesion.
  \end{itemize}
...
solutions by being noise free, allowing the use of both hands and being easily
  ...
  \section{Project Budget} \large
    The project budget can be found at the appropriate table. Yearly estimates are 
    calculated from year one costs and yearly const increases. 
    Yearly Cost increase based on inflation rate of 2.7\% as well as a 5\% business
    growth safety factor. Thus total increase for running costs is 2.7\%+5\%=7.7\%. 
  \begin{table}[H] \large
    \caption{Project Operational Budget Table for Production}
    \begin{tabular}{|l|l|l|l|l|}\hline
                      &Yearly increase & Year 1 & Year 2 & Year 3 \\ \hline 
        Cost of goods &7.7\%  & R 1554300.0 & R 1673981.1 & R 1802877.6 \\ \hline
        %Revenue               & R 4800000   & R 5376000.0 & R 6240000.0 \\ \hline
        %\textbf{Gross Profit} & R 3245700.0 & R 3635184.0 & R 4219410.0 \\
        \hline
        \multicolumn{5}{|c|}{\textbf{Overheads}} \\ \hline
        Warehouse Rent &2.7\%            & R 255600    & R 262501.2    & R 269588.7  \\ \hline 
        Salaries & 7.7\%                 & R 3163200   & R 3406766.4   & R 3669087.4 \\ \hline
        Accounting fees & 7.7\%          & R 84000     & R 90468     & R 97434.4   \\ \hline 
        Insurance fees & 7.7\%           & R 55890.0   & R 60193.53   & R 64828.4  \\ \hline
        Unforseen circumstances & 7.7\%  & R 50000     & R 53850     & R 57996.4     \\ \hline
        \multicolumn{2}{|c|}{\textbf{Total Overhead costs}} & R 3608690.0 & R 3873779.13 & R 4158935.06 \\
        \hline 
        \hline 
        \multicolumn{2}{|c|}{\textbf{Total Yearly Cost}}    & R 5162990  & R 5547760.23 & R 5961812.7 \\ \hline
    \end{tabular}
  \end{table}
